cmd_src/asm/ramdisk.o := gcc -Wp,-MD,src/asm/.ramdisk.o.d   -D__NAUTILUS__ -Iinclude  -include include/autoconf.h -D__NAUTILUS__  -m64    -c -o src/asm/ramdisk.o src/asm/ramdisk.S

deps_src/asm/ramdisk.o := \
  src/asm/ramdisk.S \
...
src/asm/ramdisk.o: $(deps_src/asm/ramdisk.o)
